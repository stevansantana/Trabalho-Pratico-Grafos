...
void lerGrafo()
{
    ...
    do
    {
        ...
        printf("Aperte:\n\n");
        printf("0 - Para sair da escolha de grafos e finalizar o programa.\n");
        printf("1 - Para ler o arquivo grafo_1.txt.\n");
        printf("2 - Para ler o arquivo grafo_2.txt.\n");
        printf("3 - Para ler o arquivo grafo_3.txt.\n");
        printf("4 - Para ler o arquivo grafo_4.txt.\n");
        printf("5 - Para ler o arquivo grafo-teste.txt.\n");
